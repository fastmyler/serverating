...
function serverating_enqueue()
{
    ...
    wp_enqueue_script('ajax-show-more', get_stylesheet_directory_uri() . '/assets/js/ajax-show-more.js', array(
        'jquery'
    ) , null, true);
    ...
    wp_enqueue_script('serverating_bootstrap_script', get_stylesheet_directory_uri() . '/assets/js/bootstrap.min.js', array(
        'jquery'
    ) , '1.0.0', true);
...
function custom_comment_callback($comment, $args, $depth)
{
    ...
    <li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
        ...
        <?php
            ...
            $avatar_url = isset($options['wpreview_avatar']) ? esc_url($options['wpreview_avatar']) : ''; // getting the image of the avatar from the options
...
// attaching the template/search.php template to the Serach results // 
